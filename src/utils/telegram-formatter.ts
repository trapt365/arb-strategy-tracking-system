...
export function formatWelcomeMessage(firstName?: string): string {
  ...
  // D1 (live-run 14.07): сначала возможности, команды — ниже вспомогательным блоком.
  return [
    `👋 ${greeting} Я — AI-трекинг бот практики.`,
    '',
    'Помогаю вести клиентов практики от стратегии до еженедельного трекинга.',
    '',
    'Что умею:',
    '• Онбординг стратегии — пришли документы (стратегия, презентация, оргструктура) текстом, голосом, файлом или фото: сам вытащу цели, ключевые результаты, гипотезы и участников и соберу всё в Google-таблицу.',
    '• Отчёты по встречам — дай запись встречи (аудио или ссылка Zoom / Google Drive), верну структурированный отчёт.',
    ...
    '/report <ссылка> — отчёт по встрече (аудио / Zoom / Google Drive)',
    '/status — готовность клиента к неделе',
    '',
    'В онбординге:',
