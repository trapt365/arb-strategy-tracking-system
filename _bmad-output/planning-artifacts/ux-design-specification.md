...
**Градиент по зрелости данных:**
- **Week 1:** Onboarding из F0 + OKR. Тон: «узнай». Формат знакомства
- **Week 2-3:** Переходный. 1-2 встречи в истории. `📎 Мало данных — повестка станет точнее через 2-3 недели`
- **Week 4+:** Полный формат. Commitments, слепые зоны, паттерны
...
| «Расстроилась бы если выключили» | Да, к Week 3 |
